...
public class Gestisimal {
    public static void main(String[] args) {
        ...
        almacenUno.add(new Articulo("111", "Macarrones", "Alimentacion", 5.55, 55.55, 5));
        almacenUno.add(new Articulo("222", "Richi Richi", "Perfumeria", 6.66, 66.66, 6));
        almacenUno.add(new Articulo("333", "Pronto", "Limpieza", 2.22, 22.55, 8));
        almacenUno.add(new Articulo("444", "Alien", "Perfumeria", 5.55, 55.55, 5));
        almacenUno.add(new Articulo("555", "Atun", "Alimentacion", 6.66, 66.66, 6));
        ...
        while(menu != 7) {
            ...
            case 1:
                ...
                String r = "n";
                System.out.println("¿Desea listar por categoría? (s/n):");
